...
CREATE TABLE okrs (id TEXT PRIMARY KEY, owner_email TEXT, scope TEXT NOT NULL CHECK(scope IN ('person','company')), objective TEXT NOT NULL, key_result TEXT NOT NULL, progress INTEGER NOT NULL, status TEXT NOT NULL, updated_at TEXT NOT NULL);
...
CREATE INDEX okrs_owner_idx ON okrs(owner_email);
