...
```sh
mkdir -p dashboards data/migrations data/wiki scripts
cp <skill-dir>/templates/cs/dashboards/*.html dashboards/
cp <skill-dir>/templates/cs/data/migrations/001_cs.sql data/migrations/
cp <skill-dir>/templates/cs/wiki/clients.md data/wiki/
cp <skill-dir>/templates/cs/scripts/wiki-to-cs-db.mjs scripts/
node scripts/wiki-to-cs-db.mjs data/wiki/clients.md data/cs.db data/migrations/001_cs.sql
```
