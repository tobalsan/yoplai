...
- Themes/print: light and dark screenshots are `validation/01-light.png` and `validation/02-dark.png`; A4 print output is `validation/03-print.pdf`; DOM evidence is `validation/01-dashboard.dom.txt`.
